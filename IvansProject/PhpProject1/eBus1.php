    ...
    <body>
        ...
        <div class="form">
            <form name="intCalc" method="post" action="eBus2.php">
                ...
                <br />
                <center>
                    <input type="button" name="btnCalc" id="btnCalc" onclick="calcSub()" value="Calculate Cost" style="background-color:yellow"  required   /><br> <br>
                    <input type="submit" name="btnAdd" id="btnAdd" onclick="" value="Add to Shopping Cart" style="background-color:greenyellow"  required /> 
                    <input type="button" name="btnClear" id="btnClear" onclick="AmountClear()" value="Clear Choice"  style="background-color:  red" required  />
